...
public class TextFieldCellFactory
        implements Callback<TableColumn<Attribute,String>,TableCell<Attribute,String>> {

    @Override
    public TableCell<Attribute, String> call(TableColumn<Attribute, String> param) {
        TextFieldCell textFieldCell = new TextFieldCell();
        return textFieldCell;
    }

    public static class TextFieldCell extends TableCell<Attribute,String> {
